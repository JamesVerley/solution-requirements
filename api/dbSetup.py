...
-- criterion
-- ======================
INSERT INTO "criterion"("id", "allocation_id", "datatype", "name", "description", "min", "max", "auxiliary") VALUES(1, 1, "percentage", "quiz", "percentage grade", "0", "100", '{}');
INSERT INTO "criterion"("id", "allocation_id", "datatype", "name", "description", "min", "max", "auxiliary") VALUES(2, 2, "checkbox", "attendance", "checkbox grade", "0", "1", '{}');
INSERT INTO "criterion"("id", "allocation_id", "datatype", "name", "description", "min", "max", "auxiliary") VALUES(3, 3, "category", "grade", "category grade", "0", "4", '{"1":"HD","2":"D","3":"C","4":"P","5":"N"}');
-- ======================
-- session
-- ======================
